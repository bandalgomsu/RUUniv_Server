...
import com.ruuniv.app.students.dto.StudentResponse
...
class StudentService(
    ...
    suspend fun sendStudentVerifyMail(email: String) = coroutineScope {
    ...
    suspend fun verifyStudentMailAuthNumber(
        email: String,
        authNumber: String,
        apiKeyId: Long
    ): StudentResponse.StudentVerifyResponse = coroutineScope {
        ...
        StudentResponse.StudentVerifyResponse(
            isStudent = isStudent,
            universityName = university.universityName
        )
    }
